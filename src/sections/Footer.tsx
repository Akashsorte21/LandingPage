...
const Footer = () => {
  return (
    <section>
      <div
        className=" md:flex bg-[#161C28] gap-x-10 pt-20 px-10 lg:px-32
         lg:flex-row text-center md:text-start "
      >
        <div className="flex-1">
          <h1 className="text-4xl lg:text-5xl font-semibold text-white mb-4 leading-[40px] md:leading-[60px]">
          ...
          <div className="">
            <Image className="mb-10 mx-auto md:mx-0" src={GroupImg} alt="" />
            ...
            <div className="flex gap-x-2 mt-10">
              <Image
                className="w-[40px] md:w-[50px] mx-auto md:mx-0"
                src={Ellipse1}
                alt=""
              />
              <Image
        ...
        <div className="flex-1 items-center justify-center bg-[#222938] rounded-[20px] py-5 mt-10 lg:mt-0">
          <div className="flex flex-col justify-center items-center ">
            ...
            <div className="w-full max-w-sm">
              <form className=" shadow-md rounded px-4 md:px-8 pt-6 mb-4">
                <div className="mb-4">
...
const Copyright = () => {
  return (
    <footer>
      <div className="bg-[#161C28] pt-20 px-10 lg:px-32 mx-auto pb-20 py-10 lg:flex text-center md:text-start">
        <div className="flex-1">
          <Image className="md:mx-0 mx-auto" src={logo} alt="" />
          <p className="text-[#A6A6A6] my-5">Get started new try our product</p>
          <div className="flex">
            <input
              className="relative py-3 w-[434px] placeholder:pl-5 rounded-full outline-none border-2 border-gray-50 bg-transparent text-white"
              type="email"
              placeholder="Enter your email here"
            />
            <div>
              <Image
                className="absolute rounded-full mt-3 m-5 left-[33%] bg-[#54BD95] hover:scale-150
        ...
        <aside>
          <div className="grid grid-flow-col lg:grid-cols-3 gap-x-5 md:gap-x-24 mt-10 lg:mt-0">
            <ul className=" ">
      ...
      <div className="flex justify-between bg-[#161C28] pb-10 px-5  lg:px-32 text-[#FFFFFF] text-lg font-medium gap-x-4 lg:gap-x-0 text-center md:text-start">
